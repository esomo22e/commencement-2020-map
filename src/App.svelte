...
// activeMarker.classList.remove('is-active');
    ...
    function navTo(index) {
        ...
        let mapPoints = document.querySelectorAll('.pin');
...
<style>
  ...
  */
    ...
    .map-graphic {
        ...
        width: 3060px;
        height: 2031px;
        transition: top 1200ms ease 0s, left 1200ms ease 0s
    }
...
<div class="map-wrapper">
    ...
    <div class="nu-map-navigation-wrapper">
        ...
        <menu class="nu-map-navigation">
            <button aria-label="Previous location"
                    class="nu-map-button nu-map-button--prev"
                    id="nu-map-button-prev">
                ➜
            </button>
            <button aria-label="Next location"
                    class="nu-map-button nu-map-button--next"
